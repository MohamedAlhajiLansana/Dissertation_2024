      ...
      <div className="flex flex-col justify-center items-center">
        <div className="border-l-4 border-l-indigo-900 px-12 py-12 bg-indigo-50">
          <div className="grid lg:grid-cols-2">
            ...
            <div>
              <h1 className="text-base font-bold">+ COMMUNITY HEALTH FUNDATION</h1>
              <h2 className="text-sm">
                2 Silicon Hill, Mile 91
              </h2>
              <h3 className="text-sm">chf@gmail.com</h3>
              <h3 className="text-sm">099234567</h3>
            </div>
            <div className=" py-12">
